...
/**
 * コマンド解決関数を注入した共通実行経路を作成する。
 */
export function createCommandRouter(resolveCommand: ResolveCommand): ProcessCommand {
  return async (text, event, say, logger, client): Promise<void> => {
